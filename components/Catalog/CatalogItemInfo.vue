<template>
    ...
    <div class="catalog-item-info">
        <div class="catalog-item-info_img">
            <CatalogItemInfoSwiper
                :catalogData="catalogData"
                :catalogDataImg="catalogData.catalogImgs"
            />
        </div>
        <div class="catalog-item-info-desription">
            <div class="catalog-item-info-desription-p">
                <p
                    class="catalog-item-info_p"
                ...
                <div
                    class="catalog-item-info_p-materials"
                    v-html="catalogData.materials"
                ></div>
                <div
                    class="catalog-item-info_p-materials"
            ...
            <div class="catalog-item-info_button-wrap">
                <div
                    class="catalog-item-info_button"
...
import CatalogItemInfoSwiper from "~~/components/Catalog/CatalogItemInfoSwiper.vue";
