<template>
    <section class="catalog container">
        <h1 class="catalog-title"><span>Другие изделия </span></h1>
        ...
        <h2 class="catalog-title"><span>Смотреть Другие изделия</span></h2>
...
<script setup>
useHead({
    title: "Royal-Wood | Другие изделия на заказ в Москве | Изготовление кухонной мебели по размерам под заказ",
});
