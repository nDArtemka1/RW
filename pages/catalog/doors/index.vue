<template>
    <section class="catalog container">
        <h1 class="catalog-title"><span>Двери</span></h1>

        <div class="catalog-descriptions">
            <p class="catalog-description">
                Наша мастерская предлагает к Вашим услугам производство
                межкомнатных дверей по индивидуальным размерам. Мы производим
                любые типы дверей: распашные, раздвижные, двустворчатые, с
                витражами, с резьбой, инкрустацией, фрезеровкой, глянцевые, со
                вставками из экзотических пород дерева, входные двери, а также
                любые дверные конструкции сложных форм и межкомнатные
                перегородки.
            </p>
            <p class="catalog-description">
                Наше производство позволяет соответствовать премиальному уровню
                готовой продукции. Основные преимущества наших дверей:
            </p>
            <div class="catalog-description">
                <ul>
                    <li>
                        Минимальная толщина двери составляет 50 мм для
                        достижения оптимальных показателей шумоизоляции.
                    </li>
                    <li>
                        Контур резинового уплотнителя - обязательная деталь
                        двери с улучшенными звукоизоляционными свойствами, а
                        также применяется для мягкого закрывания.
                    </li>
                    <li>
                        Мы используем только бесшумные замки и петли скрытого
                        монтажа.
                    </li>
                    <li>
                        Лучшими считаются изделия со сплошным заполнением без
                        пустот. Поэтому сама конструкция и наполнение полотна -
                        главное преимущество дверей от Royal Wood. Минимальный
                        вес двери - 45 кг.
                    </li>
                </ul>
            </div>
        ...
        <h2 class="catalog-title"><span>Смотреть все двери</span></h2>
