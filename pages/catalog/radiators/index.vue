<template>
    <section class="catalog container">
        <h1 class="catalog-title"><span>Панели </span></h1>
        ...
        <h2 class="catalog-title"><span>Смотреть все панели</span></h2>
...
<script setup>
useHead({
    title: "Royal-Wood | Панели на заказ в Москве | Изготовление кухонной мебели по размерам под заказ",
});
