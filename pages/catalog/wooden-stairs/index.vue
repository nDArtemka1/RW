<template>
    <section class="catalog container">
        <h1 class="catalog-title"><span>Деревянные лестницы </span></h1>
        ...
        <h2 class="catalog-title">
            <span>Смотреть все деревянные лестницы</span>
        </h2>
...
<script setup>
useHead({
    title: "Royal-Wood | Деревянные лестницы на заказ в Москве | Изготовление кухонной мебели по размерам под заказ",
});
