    ...
    <section class="catalog container">
        ...
        <div class="catalog-descriptions">
            <p class="catalog-description">
                Задача каждого стиля воссоздать дух времени. В случае с
                современным стилем Вам надо слушать только себя и создавать свой
                эталон комфорта и уюта.
            </p>
            <p class="catalog-description">
                Для лаконичного и модного дизайна сегодня мы предлагаем ровные
                фасады без фрезеровки, отсутствие лишнего декора, хром, латунь,
                глянец, подсветка, механизмы плавного закрывание фасадов и push-
                механизмы для открывания. Для облицовки фасадов может быть
                использован как нутаральный шпон дерева, так и краска. По
                каталогу RAL вы можете выбрать абсолютно любой цвет, а если не
                подберете, то мы создадим для Вас свой уникальный оттенок. Но
                главными преимуществами нашей мебели по -прежнему остаются
                эстетика , качество и долговечность.
            </p>
        </div>
