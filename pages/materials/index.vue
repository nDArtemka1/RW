<template>
    <section class="materials container">
        <h1 class="catalog-title">
            <span>Материалы используемые компанией Royal Wood</span>
        </h1>
...
const materialsItems = [
    ...
    },
    {
        title: "Сапеле",
        materials:
            "Натуральный шпон из древесины cапеле c текстурой «поммеле» [Sapele Pommele]. (может встречаться название Сапели помеле) Декоративный шпон, мебельное и краснодеревное производство, судостроение, панельная отделка, покрытие полов, столярные изделия.",
        description: "",
        description2: "",
        img: "sapele.jpg",
        catalogLink: "sapele",
    ...
    },
    {
        ...
        materials:
            "Строганая доска и шпон американского ореха используются как для строительных, столярных работ, так и для производства высококачественной мебели. Благодаря своей высокой прочности и эластичности, американский черный орех также подходит для производства стульев и кресел. Применяется в частности для изготовления оружейных прикладов и вертолетных пропеллеров. Черный грецкий орех — традиционная древесина для изготовления пианино и роялей.",
        description:
            "<strong>Основные характеристики:</strong><br/>Цвет древесины темно-коричневый. Шпон орех американский отличается своими так называемыми «птичьими клевками», сучками размером с ноготь, которые проявляются в шпоне в виде окрашенных прожилок с маленькой дырочкой в середине.",
        description2:
            "Древесина может легко обрабатываться вручную или механически любыми инструментами. Древесина  ореха отлично гнется.",
    ...
    },
    {
        ...
        materials: "",
        description:
            " Древесина обладает ни с чем не сравнимой, уникальной текстурой, которая относит её к эксклюзивным материалам для декоративной отделки и высокохудожественных изделий.",
        description2: "",
    ...
    },
    {
        ...
        materials: "",
        description:
            "Ядро темно-коричневое, с тонкими частыми прожилками, придающими древесине красивый вид. Ядро темно-коричневое, с тонкими частыми прожилками, придающими древесине красивый вид.Легко обрабатывается, но поли­руется с трудом.Пиломатериалы из этой породы, используетcя для покрытия полов и изготовления мебели. Из нее производят доброкачествен­ный декоративный шпон, пригодный для мебельного производ­ства и отделки интерьеров.",
        description2: "",
        img: "wenge.jpg",
        catalogLink: "wenge",
        catalogPathImg: "/materials/",
    ...
    },
    {
        ...
        materials: "",
        description:
            "Изготовление мебели, строганного шпона, токарных изделий.  Каштан иногда используют взамен древесины дуба.",
        description2: "",
    ...
    },
    {
        ...
        materials:
            "Красное дерево - обобщенное название тропических пород, имеющих древесину с гаммой красных оттенков. Также, это может быть насыщенный оранжевый, красно-фиолетовый или яркий бордовый оттенок.",
        description:
        ...
        description2:
            "Обычно породы группы Красного дерева используют в производстве мебели, деталей интерьера, для напольных покрытий. Некоторые из них могут применяться вне помещений за счёт природной биостойкости.",
        img: "mahogany.jpg",
    ...
    },
    {
        ...
        materials: "",
        description:
            "Заболонь кремово-белая. Цвет ядра варьирует от розовато-коричневого до интенсивного красновато-коричневого. Текстура мелкая и однородная. Древесина имеет атласный блеск, что является одним из привлекательных свойств этой породы, наряду с богатой цветовой гаммой. <br/><br/> <strong>Применение:</strong> Мебельное производство и панельная отделка внутри помещений, изготовление декоративного шпона.",
        description2: "",
    ...
    },
    {
        ...
        materials: "",
        description:
            "Покрытие полов, производство спортивного инвентаря, мебели. Отборные материалы дают декоративный шпон с крапчатыми и завитковыми узорами, который высоко ценится в отделке интерьеров высокого класса.",
        description2: "",
        img: "tamo.jpg",
        catalogLink: "tamo",
        catalogPathImg: "/materials/",
    ...
    },
    {
        title: "Этимое Wild",
        materials:
            "Новинка в ассортименте натурального шпона  - Этимое Wild, для производства дверей, мебели и панельной отделки помещений. ",
        description:
            "Этимое Wild - это настоящий африканский сюрреализм, воплощенный в дереве. Вот так, обычная тропическая порода, может выглядеть внутри.<br/> <br/>Другое название этой древесины, которое встречается в обиходе - Дэвилвуд (Devilwood), что полностью оправдывает неистовость и необузданность текстуры.<br/><br/> Вы получаете возможность проявить свою индивидуальность и произвести незабываемое впечатление на окружающих своими интерьерами.<br/><br/> <strong>Применение:</strong> Древесину Этимое используют в различных целях, таких как: производство шпона и фанеры, изготовление мебели и её компонентов, краснодеревные работы, напольные покрытия, внутренняя и внешняя панельная отделка помещений. ",
        description2: "",
        img: "etymoe-wild.jpg",
    ...
    },
    {
        ...
        materials: "",
        description:
            "Пиломатериалы из древесины ясеня дальневосточного используются в судостроении, производстве мебели, столярных изделий, паркета. Из ясеня также изготавливают высококачественный шпон и фанеру.",
        description2: "",
    ...
    },
    {
        ...
        description:
            "«Шпон корень» - особая конфигурация шпона с уникальной текстурой, получаемого из наростов (капов) на стволе дерева, что является большой редкостью. Как правило, наросты образуются на дереве в местах разрастания побегов и спящих почек в отдельных породах древесины. Кап является очень редким и красивым материалом с необычным рисунком волокон, напоминающим мрамор.",
        description2:
            "Наросты (капы), изредка образующиеся на стволах деревьев, используются для изготовления облицовочного шпона с высокими декоративными качествами, текстура такого шпона носит название «корень».",
        img: "oak-root.jpg",
